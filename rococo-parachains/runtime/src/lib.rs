...
use pallet_contracts_primitives::{
	Code, ContractInstantiateResult,
};
...
pub type CustomAssetTransactor = CustomMultiAsset<Address, AssetId, Balances, Tokens>;
...
impl Config for XcmConfig {
	...
	type AssetTransactor = CustomAssetTransactor;
...
pub const MILLICENTS: Balance = 1_000_000_0;
pub const CENTS: Balance = 1_000_000_000_000;
...
impl_runtime_apis! {
		...
		for Runtime
	{
		...
		fn instantiate(
			...
			//Contracts::instantiate(origin, endowment, gas_limit, code, data,salt)
			unimplemented!()
		}
